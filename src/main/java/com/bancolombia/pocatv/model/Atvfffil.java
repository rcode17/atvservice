...
@NoArgsConstructor
@AllArgsConstructor
@IdClass(AtvffilId.class)
public class Atvfffil {
    ...
    @Id
    @Column(name = "tmfear")
    private Date tmfear; // FECHA ARQUEO
    ...
    @Column(name = "tmobso")
    private String tmobso; // OBSERVACIONES
    ...
    @Column(name = "tmsfeb")
    private BigDecimal tmsfeb; // SALDO BOVEDA
    
    @Column(name = "tmdeb")
    private BigDecimal tmdeb; // DIFERENCIA BOVEDA
    
    @Column(name = "tmsfev")
    private BigDecimal tmsfev; // SALDO VENTANILLA
    
    @Column(name = "tmdev")
    private BigDecimal tmdev; // DIFERENCIA VENTANILLA
    ...
    @Column(name = "tmtrans")
    private String tmtrans; // TRANSACCION
    
    @Column(name = "tmsuctx")
    private String tmsuctx; // OFICINA FILIAL
}